...
set_property PACKAGE_PIN L1 [get_ports {CFlag[15]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {CFlag[15]}]
	
	
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {S7seg[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S7seg[0]}]
set_property PACKAGE_PIN W6 [get_ports {S7seg[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S7seg[1]}]
set_property PACKAGE_PIN U8 [get_ports {S7seg[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S7seg[2]}]
set_property PACKAGE_PIN V8 [get_ports {S7seg[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S7seg[3]}]
set_property PACKAGE_PIN U5 [get_ports {S7seg[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S7seg[4]}]
set_property PACKAGE_PIN V5 [get_ports {S7seg[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S7seg[5]}]
set_property PACKAGE_PIN U7 [get_ports {S7seg[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S7seg[6]}]
